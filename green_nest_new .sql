...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 27, 2023 at 06:48 AM
...
(10, 0, 'sreenandanam mutupilakkadu,mutupilacadu p.o _sasthamcotta_kollam_69520_9048986744'),
(11, 0, 'uy asssugsgusgsyavsuagsyu_poryvazi_kollam_5678_98534785'),
(12, 101, 'sreenandanam mutupilacadu_sastamcotta_kollam_987677_8596314755'),
(13, 0, 'dsdsdsds_ddsd_dsdsdsd_45777_5t7893456'),
(14, 101, 'dfdffdfdff_kollamsdsdfd_dfdfffd_455555_33333'),
(15, 101, 'dsdsdsd_uudsdsd_dsdsdd_45678_444443434'),
(18, 101, 'dsdsd_ass_dsd_2345_3435'),
(19, 117, 'ihidhf ffdh ifdfudyf dfyfy fyf_sddsd_dsdsd_456_987654322'),
(20, 102, 'sreenandanam, mutupilacadu ,mutupilaccadu p.o_mutupilacadu_kollam_690520_9048986744'),
(21, 102, 'wcceve ttv53w tvce cqw cq_333_kollam_6544_98563178');
...
INSERT INTO `admin_details` (`admin_id`, `phone_no`, `password`) VALUES
(3, '9946660844', '21232f297a57a5a743894a0e4a801fc3');
...
INSERT INTO `order_details` (`order_id`, `user_id`, `product_id`, `totalAmount`, `dateOfOrder`, `transaction_id`, `status`, `paymentMode`, `orderMessage`, `address_id`) VALUES
(302, 98, '[{\"product_id\":\"11\",\"quantity\":1}]', 599, '01-11-2023 22:40:23', '0', 'TXN_SUCCESS', 'cod', '', 0),
(303, 99, '[{\"product_id\":\"8\",\"quantity\":3}]', 99, '01-11-2023 22:45:25', '0', 'TXN_SUCCESS', 'cod', '', 0),
(304, 99, '[{\"product_id\":\"8\",\"quantity\":2},{\"product_id\":\"6\",\"quantity\":1},{\"product_id\":\"9\",\"quantity\":2}]', 697, '01-11-2023 22:55:37', '0', 'TXN_SUCCESS', 'cod', '', 0),
(305, 117, '[{\"product_id\":\"8\",\"price\":\"99\",\"quantity\":6},{\"product_id\":\"9\",\"price\":\"199\",\"quantity\":1}]', 793, '26-12-2023 20:36:47', '0', 'TXN_SUCCESS', 'cod', '', 11),
(306, 117, '[{\"product_id\":\"8\",\"price\":\"99\",\"quantity\":6},{\"product_id\":\"9\",\"price\":\"199\",\"quantity\":2},{\"product_id\":\"6\",\"price\":\"399\",\"quantity\":2}]', 1790, '26-12-2023 20:43:23', '0', 'TXN_SUCCESS', 'cod', '', 19);
...
(100, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', '9999999999'),
(101, 'aravind', 'b691c96a0e0e2674df4943221d5b4767', '', '8848310244'),
(102, 'achan', '1f2411b2f93b1342d5c06ebf4a7893e7', '', '9544281562');
...
--
ALTER TABLE `gallery`
  MODIFY `gallery_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `order_details`
--
ALTER TABLE `order_details`
  MODIFY `order_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=307;
